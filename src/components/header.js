    ...
    return (
      <div className="header">
        <h3>
          ...
          <span> | </span>
          <a href="https://github.com/gangster1221/EarthMC" target="_blank" rel="noopener noreferrer">
            GitHub
          </a>
          <span> | </span>
        ...
        <p>
          ...
          <a href="https://github.com/gangster1221/EarthMC/issues" target="_blank" rel="noopener noreferrer">
            GitHub
          </a>
          {"."}
          <br></br>
